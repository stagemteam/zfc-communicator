...
namespace Stagem\Communicator\Connector\BaseConnector;

use Stagem\Communicator\Connector\DbCommon\DataConfig;
use Stagem\Communicator\Connector\DbCommon\DataRequestConfig;
use Stagem\Communicator\Connector\DbCommon\ArrayDBDataWrapper;
use Stagem\Communicator\Connector\DbCommon\ArrayQueryWrapper;
use Stagem\Communicator\Connector\DbCommon\DBDataWrapper;
use Stagem\Communicator\Connector\DbCommon\MySQLDBDataWrapper;
use Stagem\Communicator\Connector\SchedulerConnector\SchedulerDataProcessor;
use Stagem\Communicator\Connector\Strategy\RenderStrategy;
use Stagem\Communicator\Connector\Tools\EventMaster;
use Stagem\Communicator\Connector\Tools\AccessMaster;
use Stagem\Communicator\Connector\Tools\LogMaster;
use Stagem\Communicator\Connector\XssFilter\ConnectorSecurity;
use Stagem\Communicator\Connector\DataProcessor\DataAction;
use Stagem\Communicator\Connector\Update\DataUpdate;
...
class Connector {
    ...
    protected $id_seed=0; //!< default value, used to generate auto-IDs
    ...
    public function render(){
        ...
        if ($this->live_update !== false && $this->updating!==false) {
            ...
            if ($this->editing){
                ...
                $dp = new SchedulerDataProcessor($this,$this->config,$this->request);
